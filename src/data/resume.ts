...
export const resumeData: ResumeData = {
  personal: {
    name: '손가현',
    nameEn: 'Gahyun Son',
    tagline: '사용자 경험과 비즈니스 요구사항을 연결하는 프론트엔드 개발자',
    email: 'gahyun.son6@gmail.com',
    github: 'https://github.com/gahyunson',
    linkedin: 'https://linkedin.com/in/gahyunson',
    blog: 'https://blog.gahyunson.dev',
    resumePdfUrl: '/resume.pdf',
  },
  about: {
    paragraphs: [
      '사용자 경험과 비즈니스 요구사항을 연결하며, 웹·모바일 환경의 문제를 해결해 온 프론트엔드 개발자입니다.',
      ...
      '새로운 기술을 무조건 도입하기보다 요구사항, 개발 복잡도, 유지보수성을 비교해 현재 서비스에 맞는 구현 방식을 선택합니다.',
    ],
    strengths: [
      {
        icon: '🧩',
  ...
  skills: [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Yarn Berry', level: 'advanced' },
  ...
  experience: [
    {
      ...
      achievements: [
        ...
        '의존성이 없는 초기화 작업과 API 요청을 Promise.all로 병렬화해 초기 로딩 시간을 개발 환경 49.09ms에서 8.30ms, 운영 환경 4.63ms에서 3.71ms로 단축',
  ...
  projects: [
    ...
    {
      id: 'proj-2',
      title: 'Vapor-P — 운동 분석 리포트 서비스',
      summary:
        '개인 회원이 운동 측정 결과와 분석 리포트를 조회하는 B2C 서비스입니다.',
      contribution:
        '측정 결과 조회, 분석 리포트 화면, 다국어 UI, 국가별 날짜·단위 Locale 처리를 구현해 웹·모바일 환경에서 동일한 사용 경험을 제공했습니다.',
